  ...
  return (
      ...
      <div className="pagina_loja"> 
          <ul>
            ...
            <Itemlista index={indexProduto[1]} coluna={2}/>
            <Itemlista index={indexProduto[2]} coluna={3}/>
            <Itemlista index={indexProduto[3]} coluna={4}/>
          </ul>
          <ul>
            <Itemlista index={indexProduto[4]} coluna={1}/>
            <Itemlista index={indexProduto[5]} coluna={2} />
            <Itemlista index={indexProduto[6]} coluna={3}/>
            <Itemlista index={indexProduto[7]} coluna={4}/>
          </ul>
          <ul>
            <Itemlista index={indexProduto[8]} coluna={1}/>
        ...
        <button type="button" onClick={handle_next}  className="pagebutton">Próximo</button>
        </div>
      </div>
  )
}
