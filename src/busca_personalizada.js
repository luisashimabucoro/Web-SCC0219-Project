...
function busca_personalizada(){
    ...
    const handle_pesquisa = () => {
        ...
        // console.log(localStorage.getItem('busca_personalizada'));
    }
    return(
        <div>
                ...
                <div className="pergunta">
                        ...
                        <div className="resposta">
                            {/* <form id="pergunta_espaco"> */}
                                ...
                                <div>
                                    <input type="radio" value="grande" id="muito" name="espaco"></input>
                    ...
                    <div className="botao_pesquisa">
                        <button type="button" onClick={handle_pesquisa} id="btn">
                        Pesquisar
                        </button>
                    </div>
